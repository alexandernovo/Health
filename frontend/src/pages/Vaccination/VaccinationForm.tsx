                    ...
                    <div className='flex px-5 gap-2'>
                        ...
                        <div className='w-1/3'>
                            <div className='flex flex-col w-full'>
                                ...
                                <input type="text" name='nameOfVaccinator60' onChange={handleInputChange} value={vaccination.nameOfVaccinator60} placeholder="Name of Vaccinator" className="input input-bordered w-full" />
                            </div>
                        </div>
                        <div className='w-1/3'>
                            <div className='flex flex-col w-full'>
                                <label className='font-semibold text-[14px]'>65 taon (Name of Vaccinator)</label>
                                <input type="text" name='nameOfVaccinator65' onChange={handleInputChange} value={vaccination.nameOfVaccinator65} placeholder="Name of Vaccinator" className="input input-bordered w-full" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex px-5 gap-2'>
                        <div className='w-1/3'>
                            <div className='flex flex-col w-full'>
                                ...
                                <input type="text" value={vaccination.BloodType} onChange={handleInputChange} placeholder="Blood Type" className="input input-bordered w-full" />
                            </div>
                        </div>
                        <div className='w-1/3'>
                            <div className='flex flex-col w-full'>
                                <label className='font-semibold text-[14px]'>Allergies</label>
                                <input type="text" value={vaccination.Allergies} onChange={handleInputChange} placeholder="Allergies" className="input input-bordered w-full" />
                            </div>
                        </div>
                        <div className='w-1/3'>
