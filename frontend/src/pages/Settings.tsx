    ...
    return (
        <div>
            ...
            <div className='mt-2'>
                ...
                <div className='w-[30%] border mx-auto rounded-lg  shadow-md bg-white p-3 mt-3'>
                    <button onClick={() => Logout()} className='w-full h-full text-[14px] flex items-center gap-2 font-semibold'>
