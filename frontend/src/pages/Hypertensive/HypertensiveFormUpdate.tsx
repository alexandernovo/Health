                ...
                <ul>
                    ...
                    <li>
                        <Link to={`/hypertensive_record/${appointment.user_id}`} className="inline-flex gap-2 items-center">
                            ...
                            {appointment?.firstname} ${getMiddleInitial(appointment?.middlename || '')} {appointment?.lastname} ${appointment?.extension || ''} Hypertensive/Diabetic Records
                        </Link>
                    </li>
                    <li>
                        <span className="inline-flex gap-2 items-center">
                            ...
                            Update {appointment?.firstname} ${getMiddleInitial(appointment?.middlename || '')} {appointment?.lastname} ${appointment?.extension || ''} Record
                        </span>
                    </li>
                </ul>
            </div>
