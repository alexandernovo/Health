                    ...
                    <div className='mt-4 w-[40%] mx-auto'>
                        ...
                        <div className='w-full'>
                            ...
                            <label className="h-[45px] input input-bordered flex items-center w-full mt-3">
                                ...
                                <input type="number" name="contact_number" value={userModel.contact_number} onChange={handleChange} className="grow" placeholder='Contact number' />
                            </label>
                            ...
                            <label className="h-[45px] input input-bordered flex items-center w-full mt-3">
                                ...
                                <input type="password" name="password" value={userModel.password} onChange={handleChange} className="grow" placeholder='Password' />
                            </label>
                            ...
                            <label className="h-[45px] input input-bordered flex items-center w-full mt-3">
                                ...
                                <input type="password" name="confirmPassword" value={userModel.confirmPassword} onChange={handleChange} className="grow" placeholder='Confirm Password' />
                            </label>
