            ...
            <div className="card border border-gray-100 rounded-md bg-base-100 shadow-md mb-3">
                <div className="card-body p-0 pb-3">
                    ...
                    <div className='px-5 py-2'>
                        ...
                        <table className='table border border-black mb-1 text-black'>
                            <thead>
                            ...
                            <tbody>
                                {familyAssessmentModelList.map(assessment => (
                                    <tr key={assessment.keyId} className='border-b-1 border border-black'>
                                        <td className='border border-r-1 border-black text-black'>{DateToString(assessment.dateOfVisit)}</td>
                                        <td className='border border-r-1 border-black text-black'>{assessment.medicalFindings}</td>
                                        <td className='border border-r-1 border-black text-black'>{assessment.methodAccepted}</td>
                                        <td className='border border-r-1 border-black text-black'>{assessment.nameAndSignatureSP}</td>
                                        <td className='border border-r-1 border-black text-black'>{assessment.dateFollowUp}</td>
                                        <td className='border border-r-1 border-black text-black'>
