                ...
                <div className="card-body p-0">
                    <div className='flex justify-between p-4 px-5'>
                        ...
                        <div className='flex gap-1'>
                            ...
                            <input type="text" placeholder="Search something..." className="input input-bordered input-sm w-full max-w-xs" />
                        </div>
                    </div>
                        ...
                        <table className="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status</th>
                                    <th>
                                        <button className='btn btn-success btn-outline btn-xs flex gap-1 px-4'>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
